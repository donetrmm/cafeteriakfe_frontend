    ...
    <div className="h-full flex flex-col p-8 gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {canReadSales && (
            <button
              ...
              className="flex items-center gap-2 px-4 h-11 bg-kfe-accent text-white rounded-lg hover:bg-kfe-accent/90 transition-colors"
            >
              <Receipt size={18} />
      ...
      {showSalesPanel && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          />
          <div className="relative w-[480px] bg-kfe-surface h-full shadow-2xl flex flex-col animate-slide-in-right">
            {/* Header del panel */}
